...
const OpenAiChatBot: React.FC = () => {
  ...
  return (
    <div className="fixed sm:bottom-4 sm:right-4 bottom-20 right-2 z-50 transition-transform">
      {!isChatOpen ? (
        <button
        ...
        <div className="w-full sm:w-96 h-[calc(100vh-6rem)] sm:h-[32rem] bg-gray-900 text-gray-100 shadow-xl rounded-lg flex flex-col border border-gray-700 overflow-hidden transform perspective-1000 rotate-y-0 transition-transform duration-500 ease-in-out hover:rotate-y-5">

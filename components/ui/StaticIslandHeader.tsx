    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50  font-sans">
        ...
        <div className="hidden md:block">
          <div className="rounded-full shadow-lg border bg-gray-900 bg-opacity-60 backdrop-blur-xl border-gray-600 mx-auto mt-4 hover:shadow-[0_0_15px_5px_rgba(255,255,255,0.3)] transition-shadow duration-300 max-w-5xl">
